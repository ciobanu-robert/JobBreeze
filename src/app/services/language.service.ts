...
export class LanguageService {
  readonly languages: 
  readonly LanguageDefinition[] = LANGUAGES;

  readonly currentLanguage = 
  signal<LanguageCode>(this.loadInitialLanguage());
  ...
  private loadInitialLanguage(): LanguageCode {
    ...
    const stored = 
    localStorage.getItem(LANGUAGE_STORAGE_KEY) as 
    LanguageCode | null;
    
    return stored && 
    TRANSLATIONS[stored] ? stored : DEFAULT_LANGUAGE;
  }
